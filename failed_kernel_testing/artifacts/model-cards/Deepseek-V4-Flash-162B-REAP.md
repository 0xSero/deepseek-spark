...
```bash
HF_TOKEN=... bash -lc 'set -euo pipefail; cd <spark-root>; rm -rf deepseek-spark; git clone https://github.com/0xSero/deepseek-spark.git; cd deepseek-spark; ./setup.sh full k144'
```
...
```text
run_dir: <spark-root>/benchmarks/deepseek-reap/single-server-sweep/k144-nospec-200k-mnbt8192-20260527T190139Z
