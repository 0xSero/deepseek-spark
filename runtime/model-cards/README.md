...
The full story of how these were built lives in the model cards above and the [deepseek-spark](https://github.com/0xSero/deepseek-spark) repo. The cards document the published Spark Docker image used by the one-command installer.
